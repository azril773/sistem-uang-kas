...
var Workbook = /*#__PURE__*/function () {
  ...
  _createClass(Workbook, [{
          ...
          case 'object':
            if (handler instanceof http.ServerResponse) {
              handler.writeHead(200, {
                ...
                'Content-Disposition': "attachment; filename=\"".concat(encodeURIComponent(fileName), "\"; filename*=utf-8''").concat(encodeURIComponent(fileName), ";")
              });
              handler.end(buffer);
            } else {
    ...
    value: function createStyle(opts) {
      ...
      var lookupKey = JSON.stringify(thisStyle.toObject()); // Use existing style if one exists
