...
horizontalAlignments.prototype.validate = function (val) {
  if (this[val] === undefined) {
    ...
    throw new TypeError("Invalid value for alignment.horizontal ".concat(val, "; Value must be one of ").concat(this.opts.join(', ')));
  } else {
    return true;
  }
};
...
verticalAlignments.prototype.validate = function (val) {
  if (this[val] === undefined) {
    ...
    throw new TypeError("Invalid value for alignment.vertical ".concat(val, "; Value must be one of ").concat(this.opts.join(', ')));
  } else {
    return true;
  }
};
...
readingOrders.prototype.validate = function (val) {
  if (this[val] === undefined) {
    ...
    throw new TypeError("Invalid value for alignment.readingOrder ".concat(val, "; Value must be one of ").concat(this.opts.join(', ')));
  } else {
    return true;
  }
};
