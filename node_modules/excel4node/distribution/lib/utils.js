...
var _getHashForChar = function _getHashForChar(_char, hash) {
  hash = hash ? hash : '0000';
...
var getExcelTS = function getExcelTS(date) {
  ...
  var epoch = new Date('1900-01-01T00:00:00.0000Z'); // Handle legacy leap year offset as described in  §18.17.4.1

  var legacyLeapDate = new Date('1900-02-28T23:59:59.999Z');
