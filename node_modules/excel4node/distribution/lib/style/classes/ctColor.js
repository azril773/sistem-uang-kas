    ...
    if (typeof color === 'string') {
      if (types.colorScheme[color.toLowerCase()] !== undefined) {
        ...
        try {
          ...
          throw new TypeError("Fill color must be an RGB value, Excel color (".concat(types.excelColor.opts.join(', '), ") or Excel theme (").concat(types.colorScheme.opts.join(', '), ")"));
        }
      }
    }
  }
