...
var _getFontId = function _getFontId(wb) {
  ...
  var lookupKey = JSON.stringify(thisFont.toObject()); // Find an existing entry, creating a new one if it does not exist
...
var _getFillId = function _getFillId(wb, fill) {
  ...
  var lookupKey = JSON.stringify(thisFill.toObject()); // Find an existing entry, creating a new one if it does not exist
...
var _getBorderId = function _getBorderId(wb, border) {
  ...
  var lookupKey = JSON.stringify(thisBorder.toObject()); // Find an existing entry, creating a new one if it does not exist
